...
void ayakkaldirma(int servo1,int servo2) {
  setServoPos(servo1,110);
  delay(500);
  setServoPos(servo2,110);
}

void ayakindirme(int servo1,int servo2) {
  setServoPos(servo1,92);
  delay(500);
  setServoPos(servo2,92);
}
...
/*
  int derece = 92;
  if(servonum>-1 && servonum < 8; servonum++ ){
